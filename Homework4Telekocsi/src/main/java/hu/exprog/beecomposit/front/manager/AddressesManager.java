...
@Named
@WindowScoped
public class AddressesManager extends BasicManager<Addresses> implements Serializable {
	...
	@Override
	public boolean checkEditableRights(Addresses entity) throws ActionAccessDeniedException {
		return true;
	}

	@Override
	public boolean checkDeleteRight(Addresses entity) throws ActionAccessDeniedException {
		return true;
	}
