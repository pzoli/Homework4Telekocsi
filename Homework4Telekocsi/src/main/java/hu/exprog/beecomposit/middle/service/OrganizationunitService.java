...
@Named
@Stateless
public class OrganizationunitService extends BasicService<Organizationunit> implements
		Serializable {
	...
	@Override
	public Organizationunit find(Organizationunit item) {
		return em.find(Organizationunit.class, item.getId());
	}
	...
	@Override
	public Class<Organizationunit> getDomainClass() {
