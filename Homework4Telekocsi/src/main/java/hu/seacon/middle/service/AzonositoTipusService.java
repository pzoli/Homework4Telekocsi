...
@Named
@Stateless
public class AzonositoTipusService extends BasicService<AzonositoTipus> implements
		Serializable {
	...
	@Override
	public AzonositoTipus find(AzonositoTipus item) {
		return em.find(AzonositoTipus.class, item.getId());
	}
	...
	@Override
	public Class<AzonositoTipus> getDomainClass() {
		return AzonositoTipus.class;
	}
