...
@Named
@Stateless
public class IgenyStatuszService extends BasicService<IgenyStatusz> implements
		Serializable {
	...
	@Override
	public IgenyStatusz find(IgenyStatusz item) {
		return em.find(IgenyStatusz.class, item.getId());
	}
	...
	@Override
	public Class<IgenyStatusz> getDomainClass() {
		return IgenyStatusz.class;
	}
