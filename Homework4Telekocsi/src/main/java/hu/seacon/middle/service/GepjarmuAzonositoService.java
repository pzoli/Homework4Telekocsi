...
@Named
@Stateless
public class GepjarmuAzonositoService extends BasicService<GepjarmuAzonosito> implements
		Serializable {
	...
	public GepjarmuAzonositoService() {
	...
	@Override
	public GepjarmuAzonosito find(GepjarmuAzonosito item) {
		return em.find(GepjarmuAzonosito.class, item.getId());
	}
	...
	@Override
	public Class<GepjarmuAzonosito> getDomainClass() {
		return GepjarmuAzonosito.class;
	}
