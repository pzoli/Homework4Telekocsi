...
@Named
@Stateless
public class GepjarmuMarkaService extends BasicService<GepjarmuMarka> implements
		Serializable {
	...
	@Override
	public GepjarmuMarka find(GepjarmuMarka item) {
		return em.find(GepjarmuMarka.class, item.getId());
	}
	...
	@Override
	public Class<GepjarmuMarka> getDomainClass() {
		return GepjarmuMarka.class;
	}
