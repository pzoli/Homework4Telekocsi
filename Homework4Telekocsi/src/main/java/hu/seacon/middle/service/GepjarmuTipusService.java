...
@Named
@Stateless
public class GepjarmuTipusService extends BasicService<GepjarmuTipus> implements
		Serializable {
	...
	@Override
	public GepjarmuTipus find(GepjarmuTipus item) {
		return em.find(GepjarmuTipus.class, item.getId());
	}
	...
	@Override
	public Class<GepjarmuTipus> getDomainClass() {
		return GepjarmuTipus.class;
	}
