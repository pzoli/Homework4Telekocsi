...
@Named
@Stateless
public class EntityInfoComponentService extends BasicService<EntityInfoComponent> implements
		Serializable {
	...
	public EntityInfoComponentService() {
	...
	@Override
	public EntityInfoComponent find(EntityInfoComponent item) {
		return em.find(EntityInfoComponent.class, item.getId());
	}
	...
	@Override
	public Class<EntityInfoComponent> getDomainClass() {
