...
@Named
@Stateless
public class JaratIranyService extends BasicService<JaratIrany> implements
		Serializable {
	...
	@Override
	public JaratIrany find(JaratIrany item) {
		return em.find(JaratIrany.class, item.getId());
	}
	...
	@Override
	public Class<JaratIrany> getDomainClass() {
		return JaratIrany.class;
	}
