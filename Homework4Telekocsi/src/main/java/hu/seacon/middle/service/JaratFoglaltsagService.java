...
@Named
@Stateless
public class JaratFoglaltsagService extends BasicService<JaratFoglaltsag> implements
		Serializable {
	...
	@Override
	public JaratFoglaltsag find(JaratFoglaltsag item) {
		return em.find(JaratFoglaltsag.class, item.getId());
	}
	...
	@Override
	public Class<JaratFoglaltsag> getDomainClass() {
		return JaratFoglaltsag.class;
	}
