...
@Named
@Stateless
public class GepjarmuFlottaService extends BasicService<GepjarmuFlotta> implements
		Serializable {
	...
	@Override
	public GepjarmuFlotta find(GepjarmuFlotta item) {
		return em.find(GepjarmuFlotta.class, item.getId());
	}
	...
	@Override
	public Class<GepjarmuFlotta> getDomainClass() {
		return GepjarmuFlotta.class;
	}
